    ...
    pub fn start_job(&self, job_id: String, ua_manager: crate::UserAgentManager) -> Result<(), String> {
        ...
        tauri::async_runtime::spawn(async move {
            ...
            for _ in 0..settings.bot_count {
                ...
                let ua_manager_clone = ua_manager.clone();
                ...
                handles.push(tauri::async_runtime::spawn(async move {
                    loop {
                        ...
                        // EXECUTE
                        let res = engine::execute_config_with_client(conf.clone(), line.clone(), p_str.clone(), None::<fn(engine::ExecutionLog)>, ua_manager_clone.clone()).await;
