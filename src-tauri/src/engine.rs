...
const ALL_EMULATIONS: &[Emulation] = &[
    ...
    Emulation::Chrome134, Emulation::Chrome135, Emulation::Chrome136, Emulation::Chrome137, Emulation::Chrome138,
    Emulation::Chrome139, Emulation::Chrome140, Emulation::Chrome141, Emulation::Chrome142, Emulation::Chrome143,
    Emulation::Firefox109, Emulation::Firefox117, Emulation::Firefox128, Emulation::Firefox133,
    Emulation::Firefox135, Emulation::Firefox136, Emulation::Firefox139, Emulation::Firefox142,
    Emulation::Firefox143, Emulation::Firefox144, Emulation::Firefox145, Emulation::Firefox146,
    ...
    Emulation::Safari17_5, Emulation::Safari17_6, Emulation::Safari18, Emulation::Safari18_2,
    Emulation::Safari18_3, Emulation::Safari18_3_1, Emulation::Safari18_5,
    Emulation::Safari26, Emulation::Safari26_1, Emulation::Safari26_2,
    Emulation::SafariIos16_5, Emulation::SafariIos17_2, Emulation::SafariIos17_4_1, Emulation::SafariIos18_1_1,
    Emulation::SafariIos26, Emulation::SafariIos26_2,
    Emulation::SafariIPad18, Emulation::SafariIPad26, Emulation::SafariIpad26_2,
    Emulation::Edge101, Emulation::Edge122, Emulation::Edge127, Emulation::Edge131, Emulation::Edge134,
    Emulation::Edge135, Emulation::Edge136, Emulation::Edge137, Emulation::Edge138, Emulation::Edge139,
    Emulation::Edge140, Emulation::Edge141, Emulation::Edge142,
...
fn parse_wreq_emulation(s: &str) -> Emulation {
    match s.to_lowercase().as_str() {
        ...
        "chrome136" => Emulation::Chrome136, "chrome137" => Emulation::Chrome137, "chrome138" => Emulation::Chrome138,
        "chrome139" => Emulation::Chrome139, "chrome140" => Emulation::Chrome140, "chrome141" => Emulation::Chrome141,
        "chrome142" => Emulation::Chrome142, "chrome143" => Emulation::Chrome143,
        ...
        "firefox139" => Emulation::Firefox139, "firefox142" => Emulation::Firefox142,
        "firefox143" => Emulation::Firefox143, "firefox144" => Emulation::Firefox144,
        "firefox145" => Emulation::Firefox145, "firefox146" => Emulation::Firefox146,
        ...
        "safari17_5" | "safari17.5" => Emulation::Safari17_5, "safari17_6" | "safari17.6" => Emulation::Safari17_6,
        "safari18" => Emulation::Safari18, "safari18_2" | "safari18.2" => Emulation::Safari18_2,
        "safari18_3" | "safari18.3" => Emulation::Safari18_3, "safari18_3_1" | "safari18.3.1" => Emulation::Safari18_3_1,
        "safari18_5" | "safari18.5" => Emulation::Safari18_5,
        "safari26" => Emulation::Safari26, "safari26_1" | "safari26.1" => Emulation::Safari26_1,
        "safari26_2" | "safari26.2" => Emulation::Safari26_2,
        "safariios16_5" | "safariios16.5" => Emulation::SafariIos16_5,
        "safariios17_2" | "safariios17.2" => Emulation::SafariIos17_2, "safariios17_4_1" | "safariios17.4.1" => Emulation::SafariIos17_4_1,
        "safariios18_1_1" | "safariios18.1.1" => Emulation::SafariIos18_1_1,
        "safariios26" => Emulation::SafariIos26, "safariios26_2" | "safariios26.2" => Emulation::SafariIos26_2,
        "safariipad18" => Emulation::SafariIPad18, "safariipad26" => Emulation::SafariIPad26,
        "safariipad26_2" | "safariipad26.2" => Emulation::SafariIpad26_2,
        "edge101" => Emulation::Edge101, "edge122" => Emulation::Edge122, "edge127" => Emulation::Edge127,
        "edge131" => Emulation::Edge131, "edge134" => Emulation::Edge134, "edge135" => Emulation::Edge135,
        "edge136" => Emulation::Edge136, "edge137" => Emulation::Edge137, "edge138" => Emulation::Edge138,
        "edge139" => Emulation::Edge139, "edge140" => Emulation::Edge140, "edge141" => Emulation::Edge141,
        ...
        match block.block_type {
            ...
            BlockType::Request => {
                ...
                if ctx.current_auto_redirect {
                    ...
                    // Proxy logic: Block-level use_proxy toggle > Block proxy_url > Global Context > None
                    let block_use_proxy = block.data.get("use_proxy").and_then(|v| v.as_bool()).unwrap_or(true);
                    if block_use_proxy {
                ...
                loop {
                    ...
                    if redirect_count == 0 {
                        ...
                        if !body_handled {
                            ...
                            } else if matches!(method_name.as_str(), "POST" | "PUT" | "PATCH") {
            ...
            BlockType::TlsWreq => {
                ...
                // Parse user headers (Vec preserves insertion order for accurate header ordering)
                let mut user_headers: Vec<(String, String)> = Vec::new();
                if let Some(h_str) = block.data.get("headers").and_then(|v| v.as_str()) {
                    for line in h_str.lines() {
                        if let Some((k, v)) = line.split_once(':') {
                            let key = k.trim();
                            if !key.is_empty() {
                                let val = ctx.replace_vars(v.trim());
                                user_headers.push((key.to_string(), val));
                            }
                        }
                    }
                ...
                // Proxy handling
                let block_use_proxy = block.data.get("use_proxy").and_then(|v| v.as_bool()).unwrap_or(true);
                let proxy_url = if block_use_proxy {
                    let block_proxy_raw = block.data.get("proxy_url").and_then(|v| v.as_str()).unwrap_or("");
                    if !block_proxy_raw.trim().is_empty() {
                        Some(format_proxy_to_url(&ctx.replace_vars(block_proxy_raw)))
                    } else {
                ...
                match client_result {
                    Ok(client) => {
                        ...
                        // Start Redirect Loop
                        loop {
                            let mut headers_to_use: Vec<(String, String)> = if redirect_count == 0 {
                                user_headers.clone()
                            } else {
                                Vec::new()
                            };
                            ...
                            if !headers_to_use.iter().any(|(k, _)| k.eq_ignore_ascii_case("Origin")) {
                                if let Ok(parsed) = reqwest::Url::parse(&current_url) {
                                    if let Some(host) = parsed.host_str() {
                                        let origin = format!("{}://{}", parsed.scheme(), host);
                                        headers_to_use.push(("Origin".into(), origin));
                                    }
                                }
                            }

                            // Inject Cookies (only if user didn't provide their own Cookie header)
                            let has_user_cookie = headers_to_use.iter().any(|(k, _)| k.eq_ignore_ascii_case("Cookie"));
                            if !has_user_cookie {
                                let cookie_str: String = cookie_map.iter().map(|(k, v)| format!("{}={}", k, v)).collect::<Vec<_>>().join("; ");
                                if !cookie_str.is_empty() {
                                    headers_to_use.push(("Cookie".to_string(), cookie_str.clone()));
                                }
                            }

                            // Shuffle headers if needed
                            let headers_to_add: Vec<&(String, String)> = if randomize_header_order {
                                use rand::seq::SliceRandom;
                                let mut shuffled: Vec<_> = headers_to_use.iter().collect();
                                shuffled.shuffle(&mut rand::rng());
                                shuffled
                            } else {
                                headers_to_use.iter().collect()
                            };
                            ...
                            if redirect_count == 0 {
                                req_hs_log = headers_to_use.iter().cloned().collect();
            ...
            BlockType::CurrentUnixTime => {
                let use_millis = block.data.get("use_millis").and_then(|v| v.as_bool()).unwrap_or(false);
                let ts = if use_millis {
            ...
            BlockType::JumpIF => {
                ...
                if let Some(jump_chains) = block.data.get("jump_chains").and_then(|v| v.as_array()) {
                    // New format: jump_chains array
                    for jc in jump_chains {
                        let source_var = jc.get("source").and_then(|v| v.as_str()).filter(|s| !s.is_empty()).unwrap_or("SOURCE");
                        let mode = jc.get("mode").and_then(|v| v.as_str()).unwrap_or("OR");
                        let target = jc.get("target").and_then(|v| v.as_str()).unwrap_or("");
                        let source_val = ctx.variables.get(source_var).cloned().unwrap_or_default();

                        let keys = jc.get("keys").and_then(|v| v.as_array());
                        let chain_matches = if let Some(keys) = keys {
                            let results: Vec<bool> = keys.iter().map(|key| {
                                let condition = key.get("condition").and_then(|v| v.as_str()).unwrap_or("Contains");
                                let value = ctx.replace_vars(key.get("value").and_then(|v| v.as_str()).unwrap_or(""));
                                match condition {
                                    "Contains" => source_val.contains(&value),
                                    "NotContains" => !source_val.contains(&value),
                                    "Equal" => source_val == value,
                                    "NotEqual" => source_val != value,
                                    "StartsWith" => source_val.starts_with(&value),
                                    "EndsWith" => source_val.ends_with(&value),
                                    "Matches" => regex::Regex::new(&value).map(|re| re.is_match(&source_val)).unwrap_or(false),
                                    _ => false,
                                }
                            }).collect();
                        ...
                        if chain_matches {
                            if let Some(&target_idx) = labels.get(target) {
                                log_and_emit(&mut ctx, "JumpIF", &format!("Condition met on {}, jumping to #{}", source_var, target), "Success", None, bid.clone(), block_start_time);
                                block_idx = target_idx;
                                jumped = true;
                                break;
                            } else {
                                log_and_emit(&mut ctx, "JumpIF", &format!("Label #{} not found!", target), "Error", None, bid.clone(), block_start_time);
                            }
                        }
                    }

                    if !jumped {
                        log_and_emit(&mut ctx, "JumpIF", "No jump chain conditions met", "Info", None, bid.clone(), block_start_time);
                    }
                } else {
                    ...
                    if matches {
                        if let Some(&target_idx) = labels.get(target) {
                            log_and_emit(&mut ctx, "JumpIF", &format!("Condition met: {} {} \"{}\", jumping to #{}", source_var, condition, value, target), "Success", None, bid.clone(), block_start_time);
                            block_idx = target_idx;
                            jumped = true;
                        } else {
                            log_and_emit(&mut ctx, "JumpIF", &format!("Label #{} not found!", target), "Error", None, bid.clone(), block_start_time);
                        ...
                        log_and_emit(&mut ctx, "JumpIF", &format!("Condition not met: {} {} \"{}\"", source_var, condition, value), "Info", None, bid.clone(), block_start_time);
                    }
                }

                if jumped {
                    let delay_ms = block.data.get("delay_ms").and_then(|v| v.as_u64()).unwrap_or(0);
                    if delay_ms > 0 {
                        log_and_emit(&mut ctx, "JumpIF", &format!("Waiting {} ms before jump...", delay_ms), "Info", None, bid.clone(), block_start_time);
